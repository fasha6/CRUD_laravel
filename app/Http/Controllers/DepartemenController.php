...
class DepartemenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('departemen')->with('sukses', 'Departemen Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        return redirect('departemen')->with('sukses', 'Departemen Berhasil Dirubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('departemen')->with('sukses', 'Departemen Berhasil Dihapus');
    }
}
